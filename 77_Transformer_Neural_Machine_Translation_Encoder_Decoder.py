...
_Header(3, "Token Embedding and Positional Embedding")
...
_Header(4, "Transformer Encoder Block")
...
_Header(5, "Transformer Decoder Block")
...
_Header(6, "Complete Transformer Model Building")
...
_Header(8, "Reverse Vocabulary Creation")
...
_Header(9, "Translation Function")
...
_Header(10, "Final Translation Testing")
