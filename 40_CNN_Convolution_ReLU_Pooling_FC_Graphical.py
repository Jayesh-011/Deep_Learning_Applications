...
# ------------------------------------------------------------
def _ShowConvolutionStep(image, kernel, start_row, start_col, current_output=None, step_title=""):
...
# ------------------------------------------------------------
def _Convolution_Animated(image, kernel, delay=1.5):
...
# ------------------------------------------------------------
def _ShowPoolingStep(feature_map, start_row, start_col, current_output=None, step_title=""):
...
# ------------------------------------------------------------
def _Pooling_Animated(data, delay=1.5):
...
# ------------------------------------------------------------
def _ShowPipeline(image, conv, relu, pool):
...
def _CNN_Animated():
    ...
    print(kernel)
    _Display(kernel, "Kernel")

    conv = _Convolution_Animated(image, kernel, delay=1.0)
    _Display(conv, "Final Convolution Output")

    relu = _ReLU(conv)
    _Display(relu, "ReLU Output")

    pool = _Pooling_Animated(relu, delay=1.0)
    _Display(pool, "Final Pooling Output")
    ...
    _ShowPipeline(image, conv, relu, pool)
