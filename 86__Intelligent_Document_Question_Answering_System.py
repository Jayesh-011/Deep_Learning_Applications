...
def ask_llm(question, context):
    prompt = f"""
You are an intelligent document question answering assistant created for an IT Organization.
...
<b>Author:</b> Jayesh Mahendra Patil<br><br>
...
<hr>
<b> </b><br>
Project developed by Jayesh Mahendra Patil | Date: 09/05/2026
</div>
""", unsafe_allow_html=True)