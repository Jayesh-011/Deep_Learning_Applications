...
_Header("MARVELLOUS INFOSYSTEMS - RELIANCE STOCK FORECASTING USING LSTM")
...
_Header("STEP 2 : DATE CONVERSION AND SORTING")
...
_Header("STEP 3 : EXTRACT CLOSE PRICE FOR FORECASTING")
...
_Header("STEP 4 : MIN-MAX SCALING WITH MANUAL CALCULATION")
...
_Header("STEP 5 : TIME SERIES SEQUENCE CREATION")
...
_Header("STEP 6 : RESHAPE DATA FOR LSTM INPUT")
...
_Header("STEP 7 : LSTM INTERNAL WORKING CONCEPT")
...
_Header("STEP 8 : SIMPLE MANUAL LSTM GATE CALCULATION DEMO")
...
_Header("STEP 9 : TRAIN TEST SPLIT")
...
_Header("STEP 10 : BUILD LSTM MODEL")
...
_Header("STEP 11 : MODEL TRAINING")
...
_Header("STEP 12 : PREDICTION ON TEST DATA")
...
_Header("STEP 13 : CONVERT SCALED VALUES BACK TO ORIGINAL PRICE")
...
_Header("STEP 14 : MODEL EVALUATION WITH CALCULATIONS")
...
_Header("STEP 15 : ACTUAL VS PREDICTED GRAPH")
...
_Header("STEP 16 : TRAINING LOSS GRAPH")
...
_Header("STEP 17 : NEXT DAY PRICE PREDICTION")
...
_Header("STEP 18 : SAVE MODEL AND PREDICTION OUTPUT")
