...
# ------------------------------------------------------------
def _Draw_Values(ax, matrix, text_color="black"):
...
_Print_Matrix("3x3 Kernel", kernel)
...
for i in range(4):
    for j in range(4):
        ...
        axes[1].set_title(" Current 3x3 Region")
        _Draw_Values(axes[1], region)
        ...
        _Draw_Values(axes[3], feature_map)
