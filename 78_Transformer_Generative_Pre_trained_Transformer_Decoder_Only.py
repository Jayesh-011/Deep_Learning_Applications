...
_Header(2, "Tokenization and Padding")
...
_Header(3, "Input and Target Preparation")
...
_Header(4, "Token Embedding and Positional Embedding")
...
_Header(5, "Decoder-Only Transformer Block")
...
_Header(6, "Causal Mask Demonstration")
...
_Header(9, "Reverse Vocabulary Creation")
...
_Header(10, "Next Word Prediction Function")
...
_Header(11, "Autoregressive Text Generation")
