...
def _neuron_forward(inputs, weights, bias, activation_func):
...
def main():
    ...
    _neuron_forward(inputs, weights, bias, sigmoid)

    # ReLU neuron
    print("=== ReLU Neuron ===")
    _neuron_forward(inputs, weights, bias, relu)
