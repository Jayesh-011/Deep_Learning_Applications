...
_Print_Matrix("Original 6x6 Image", image)
...
_Print_Matrix("3x3 Edge Detection Kernel", kernel)
...
for i in range(4):
    for j in range(4):
        ...
        _Print_Matrix("Current 3x3 Region from Image", region)

        # Element-wise multiplication
        multiplied = region * kernel
        _Print_Matrix("Region * Kernel", multiplied)
        ...
        _Print_Matrix("Feature Map Built So Far", feature_map)

# ------------------------------------------------------------
# Step 5 : Final Feature Map
# ------------------------------------------------------------
_Print_Matrix("Final Feature Map", feature_map)
